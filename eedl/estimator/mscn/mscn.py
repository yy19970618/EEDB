...
from eedl.workload.workload import load_queryset, load_labels, query_2_triple
from eedl.constants import DEVICE, MODEL_ROOT, NUM_THREADS
import myArgs
...
if __name__ == '__main__':
    ...
    # *****************************************************************************************************************************
    query_total = getQueryData(DATA_ROOT, "census13")
    table = getTable("census13", "original")
    db = DBInterface()
